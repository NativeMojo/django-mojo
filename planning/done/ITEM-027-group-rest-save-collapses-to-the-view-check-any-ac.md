...
opened: 2026-07-10
depends_on: []
related: [ITEM-016, ITEM-019, ITEM-021]
links: []
---
...
- [ ] ApiKey behavior preserved: confined key holding the perm can save its
      group; zero-perm or unconfined key cannot (ITEM-019 bar).
...
- **ApiKey:** zero-perm/unconfined denied (ITEM-019 bar preserved); confined key
  with perm allowed.
...
- Session-start tree state: the working tree carried **uncommitted, unrelated**
  ...
  (`563e430`) after confirming the baseline green — so the ITEM-027 commit stays
