...
— same approach as ITEM-003). Exact assertions depend on the approach chosen
...
- **Out of scope (tracked separately):** the "signup didn't log me in" reports are NOT this item.
  Most likely ITEM-005 (one wrong code burns the register session). A code review also surfaced a
