...
- closed: 2026-06-07
- branch: main
- files changed: CHANGELOG.md,mojo/apps/account/templates/account/register.html,tests/test_auth/bouncer_forms.py (commit a657dfb; the close.sh auto-stamp diffed origin/main and also listed the unpushed DM-002 commit's files — trimmed to this item's actual change)
