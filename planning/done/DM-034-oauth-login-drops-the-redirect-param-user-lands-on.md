...
- `CHANGELOG.md` — v1.2.46 was released 2026-07-10, so start a new rolling block
  ...
  `**bug** — **OAuth login preserves ?redirect= across the provider round-trip** … (DM-034)`.
...
- closed: 2026-07-11
- branch: main
- files changed: CHANGELOG.md,docs/django_developer/account/bouncer.md,docs/django_developer/account/oauth.md,docs/web_developer/account/auth_pages.md,docs/web_developer/account/oauth.md,mojo/apps/account/rest/oauth.py,mojo/apps/account/static/account/mojo-auth.js,planning/.next_id,planning/in_progress/DM-034-oauth-login-drops-the-redirect-param-user-lands-on.md,tests/test_oauth/oauth.py,uv.lock
- tests added:
