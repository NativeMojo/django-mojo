...
- Build baseline (2026-07-03, `bin/run_tests --agent`, default suite): **GREEN** — 2278 total,
  ...
  Any failure after this change is attributable to DM-012.
...
- closed: 2026-07-03
- branch: main
- files changed: CHANGELOG.md,docs/django_developer/account/auth.md,docs/django_developer/core/middleware.md,docs/web_developer/core/request_response.md,mojo/middleware/auth.py,planning/in_progress/DM-012-auth-middleware-500s-on-a-malformed-authorization-.md,tests/test_middleware/__init__.py,tests/test_middleware/auth_malformed_header.py,uv.lock
