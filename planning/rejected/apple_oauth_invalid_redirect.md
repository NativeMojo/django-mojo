...
The redirect_uri `https://REDACTED.com/auth/` is a **frontend SPA URL**. Apple's
...
```python
APPLE_REDIRECT_URI        # Backend callback URL: https://REDACTED.com/api/auth/oauth/apple/callback
APPLE_CALLBACK_REDIRECT   # Frontend destination after callback: https://REDACTED.com/auth/
```
