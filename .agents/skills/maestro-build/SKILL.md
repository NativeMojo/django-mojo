...
description: >-
  ...
  Plan inside this repo with full build discipline, keep the item's activity
  trail updated (commits, tests, blockers), and land it at review/done via the
  maestro MCP.
---

<!-- Generated from .claude/skills/maestro-build/SKILL.md (maestro-skill-version: 3). Do not edit directly. -->
...
(read the repo's `AGENTS.md` / rules first). The board item is the work
