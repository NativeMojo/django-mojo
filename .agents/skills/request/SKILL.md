...
name: request
description: >-
  File a request for new work from chat — a feature, bug, or chore. Determines
  the type itself, explores/clarifies (for a bug: best-effort confirms the
  root cause), and writes a structured, un-ID'd item to planning/inbox/. Does
  not implement or allocate an id; $scope picks it up next.
---

<!-- Generated from .claude/skills/request/SKILL.md. Do not edit directly. -->
...
intake next. Read `AGENTS.md` for conventions first.
