...
The ACCOUNT_CLOSURE_HANDLER delegation tests, which override
django.conf.settings in-process, live in
tests/test_user_mgmt_extended_serial/deactivation.py (maestro item #1839).
The handler doubles they import stay here in `_closure_handlers.py` so their
dotted paths keep resolving.
"""
...
# ===========================================================================
# Source pin (the ACCOUNT_CLOSURE_HANDLER delegation tests themselves live in
# tests/test_user_mgmt_extended_serial/deactivation.py — maestro item #1839)
# ===========================================================================
