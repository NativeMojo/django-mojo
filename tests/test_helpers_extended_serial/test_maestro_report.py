...
Moved out of tests/test_helpers/test_maestro_report.py: every test here writes
MAESTRO_*/CI environment variables and/or patches testit.maestro module
attributes — process-global mutations visible to every parallel module — so
they run only in the opt-in serial tier (maestro item #1839). The tests that
touch no shared state stayed behind.
