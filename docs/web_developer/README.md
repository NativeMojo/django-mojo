...
| [assistant/mcp](assistant/mcp.md) | Connecting an AI client over MCP — the endpoint, the sign-in hand-off, the wire shapes, the approval hand-off and the error table |
