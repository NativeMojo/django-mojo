...
JOBS_CHANNELS
    Channels this box CONSUMES (engine + scheduler). Override per process with
    `--channels a,b` on the jobs CLI. Publishing to a channel this box
    consumes is always allowed.
