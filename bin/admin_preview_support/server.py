...
def main():
    ...
    parser.add_argument("--security-state", choices=("full", "empty", "unavailable", "view-only", "no-access", "partial", "failed", "stale", "expired-session", "440", "conflict", "recovery", "malformed"), default="full")
